...
class gui:
    def __init__(self ):
        ...
        self.img1 = tkinter.PhotoImage("frameFocusBorder", data="""
        ...
        self.img2 = tkinter.PhotoImage("frameBorder", data="""
        R0lGODlhQABAAPcAAHx+fMTCxKSipOTi5JSSlNTS1LSytPTy9IyKjMzKzKyq
        rOzq7JyanNza3Ly6vPz6/ISChMTGxKSmpOTm5JSWlNTW1LS2tPT29IyOjMzO
        zKyurOzu7JyenNze3Ly+vPz+/OkAKOUA5IEAEnwAAACuQACUAAFBAAB+AFYd
        QAC0AABBAAB+AIjMAuEEABINAAAAAHMgAQAAAAAAAAAAAKjSxOIEJBIIpQAA
        ...
        self.frame = ttk.Frame(style="RoundedFrame", padding=10)
        self.frame.pack(fill='x')

        self.frame2 = ttk.Frame(style="RoundedFrame", padding=10)
        self.frame2.pack(fill='both', expand=1)

        self.entry = ttk.Entry(self.frame, text='Test')
        self.entry.pack(fill='x')
        self.entry.bind("<FocusIn>", lambda evt: self.frame.state(["focus"]))
        self.entry.bind("<FocusOut>", lambda evt: self.frame.state(["!focus"]))

        self.text = tkinter.Text(self.frame2, borderwidth=0, bg="white", highlightthickness=0)
        self.text.pack(fill='both', expand=1)
        self.text.bind("<FocusIn>", lambda evt: self.frame2.state(["focus"]))
        self.text.bind("<FocusOut>", lambda evt: self.frame2.state(["!focus"]))
